...
const SidebarOption: React.FC<SidebarOptionProps> = ({ href, id, onClick }) => {
  ...
  return (
    <Link 
      href={href} 
      className={`border p-2 rounded-md ${isActive ? "bg-gray-300 font-bold border-black" : "border-gray-400"} flex items-center`} 
