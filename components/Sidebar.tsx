...
const Sidebar = () => {
  ...
  // State to hold grouped data for documents
  ...
  // Group items based on whether the user is an owner or a document is shared with them
  useEffect(() => {
    if (!data) return;
  ...
  // Handle sidebar option click to close the sidebar
          ...
          <>
            ...
            {groupedData.owner.map((doc) => (
              <SidebarOption
                ...
                id={doc.id}
                href={`/doc/${doc.id}`}
                onClick={handleSidebarOptionClick} // Close sidebar on click
              />
            ))}
          </>
        )}
